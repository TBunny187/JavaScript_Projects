...
function placeXOrO (squareNumber) {
    ...
    // the .some() method is used to check each element in the selectSquare array
    // to see if it contains the square number clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        // This variable retrieves the HTML element id that was clicked.
        let select = document.getElementById(squareNumber);
        // This condition cheks who's turn it is.
        if (activePlayer === 'X') {
            // If activePlayer is 'X', the x.png is placed
...
function checkWinConditions () {
    ...
    // 9 squares are selected, this code executes.
    ...
    function arrayIncludes (squareA, squareB, squareC)  {
        ...
        // If the 3 variables are included in our array then
        // true is returned and our condition executes drawLine().
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    // This line accesses our HTML canvas elemnet.
    ...
    // This disables clicking while win sound is playing
    disableClick();
    // This plays the win sounds.
    audio('./media/winGame.mp3');
    // This calls our main animation loop.
    animateLineDrawing();
    // This waits 1 second. Then clears canvas, resets game, and allows clicking
